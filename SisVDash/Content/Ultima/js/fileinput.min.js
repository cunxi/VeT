...
! function (e) {
    ...
    t = {
                ...
                i.resumableManager = {
                    ...
                    sendAjax: function (e, a) {
                        ...
                        if (!l.processed[c] || !l.processed[c][e]) {
                            ...
                            var g, m, v, h, w, b, _ = u.slice ? "slice" : u.mozSlice ? "mozSlice" : u.webkitSlice ? "webkitSlice" : "slice",
                                C = u[_](d * e, d * (e + 1));
        ...
        _initPreviewCache: function () {
            ...
            i.previewCache = {
                ...
                get: function (a, r) {
                    ...
                    return m && m.length ? (r = void 0 === r ? !0 : r, l = t.ifSet("type", g, i.initialPreviewFileType || "generic"), d = t.ifSet("filename", g, t.ifSet("caption", g)), c = t.ifSet("filetype", g, l), s = i.previewCache.footer(a, r, g && g.size || null), u = t.ifSet("frameClass", g), n = v ? w(l, m, d, c, s, p, u) : w("generic", m, d, c, s, p, u, l).setTokens({
                        content: f.content[a]
        ...
        _uploadSingle: function (i, a, r) {
            var n, o, l, s, d, c, u, p, f, g, m, v, h, w = this,
                b = w.fileManager,
                _ = b.count(),
                C = new FormData,
                y = w._getThumbId(a),
            ...
            w.enableResumableUpload || (w.showPreview && (o = w.fileManager.getThumb(a), u = o.find(".file-thumb-progress"), s = o.find(".kv-file-upload"), d = o.find(".kv-file-remove"), u.show()), 0 === _ || !x || w.showPreview && s && s.hasClass("disabled") || w._abort(I) || (h = function () {
                ...
                f = w._parseError(T, t, n, w.fileManager.getFileName(a)), c = !0, setTimeout(function () {
                    var i;
                    r && h(), w.fileManager.setProgress(a, 100), w._setPreviewError(o, !0), w.retryErrorUploads || s.hide(), e.extend(!0, I, w._getOutData(C, t)), w._setProgress(101, w.$progress, w.msgAjaxProgressError.replace("{operation}", T)), i = w.showPreview && o ? o.find(".file-thumb-progress") : "", w._setProgress(101, i, w.msgUploadError), w._showFileError(f, I)
                }, w.processDelay)
            }, C.append(w.uploadFileAttr, F.file, P), w._setUploadData(C, {
                fileId: a
            ...
            i.showPreview && (i._initZoomButton(), i.getFrames(" .kv-file-remove").each(function () {
                ...
                i._handler(n, "click", function () {
                    return r = i._raise("filepreremove", [l, s]), r !== !1 && i._validateMinCount() ? (a = o.hasClass("file-preview-error"), t.cleanMemory(o), void o.fadeOut("slow", function () {
                        t.cleanZoomCache(i._getZoom(l)), i.fileManager.remove(o), i._clearObjects(o), o.remove(), l && a && i.$errorContainer.find('li[data-thumb-id="' + l + '"]').fadeOut("fast", function () {
        ...
        _initPreviewActions: function () {
            ...
            i._initZoomButton(), a.find(n).each(function () {
                ...
                if (!t.isEmpty(p) && void 0 !== f) {
                    ...
                    var m, v, h, w, b, _ = u.closest(t.FRAMES),
                        C = i.previewCache.data,
                        y = _.attr("data-fileindex");
                    y = parseInt(y.replace(t.INIT_FLAG, "")), h = t.isEmpty(C.config) && t.isEmpty(C.config[y]) ? null : C.config[y], b = t.isEmpty(h) || t.isEmpty(h.extra) ? r : h.extra, w = h.filename || h.caption || "", "function" == typeof b && (b = b()), v = {
                        id: u.attr("id"),
                        key: f,
                        extra: b
                    }, n = function (e) {
                        ...
                        return t.isEmpty(e) || t.isEmpty(e.error) ? (_.removeClass("file-uploading").addClass("file-deleted"), void _.fadeOut("slow", function () {
                            y = parseInt(_.attr("data-fileindex").replace(t.INIT_FLAG, "")), i.previewCache.unset(y), i._deleteFileIndex(_), o = i.previewCache.count(!0), c = o > 0 ? i._getMsgSelected(o) : "", i._setCaption(c), i._raise("filedeleted", [f, n, b]), t.cleanZoomCache(i._getZoom(_.attr("id"))), i._clearObjects(_), _.remove(), d()
        ...
        _getExifObj: function (e) {
            ...
            return a || i._log(t.logMessages.badExifParser, {
                details: r
            }), a
        },
        ...
        _getResizedImage: function (i, a, r, n) {
            var o, l, s, d, c, u, p, f, g, m, v = this,
                h = e(a.img)[0],
                w = h.naturalWidth,
                b = h.naturalHeight,
                _ = 1,
            ...
            if (c = function (e, t, i) {
                ...
                index: E,
                fileId: i
            }, m = [i, P, E], (!f || !x || C >= w && y >= b) && (x && f && v._raise("fileimageresized", m), r.val++ , r.val === n && v._raise("fileimagesresized"), !x)) return void c(v.msgImageResizeError, g, "fileimageresizeerror");
        ...
        readFiles: function (i) {
            ...
            var a, r = this,
                ...
                w = function (t, n, o, l, s, d) {
                    var c, u = e.extend(!0, {}, r._getOutData(null, {}, {}, i), {
                        id: o,
                        index: l,
                        fileId: s
                    }),
                    ...
                    d = d || r.removeFromPreviewOnError, d || r._previewDefault(n, !0), c = r._getFrame(o, !0), r.isAjaxUpload ? setTimeout(function () {
                        a(l + 1)
                    }, r.processDelay) : (r.unlock(), p = 0), d && c.length ? c.remove() : (r._initFileActions(), c.find(".kv-file-upload").remove()), r.isError = r.isAjaxUpload ? r._showFileError(t, u) : r._showError(t, f), r._updateFileDetails(p)
                };
            r.fileManager.clearImages(), e.each(i, function (e, t) {
                var i = r.fileTypeSettings.image;
                i && i(t.type) && r.fileManager.totalImages++
            }), a = function (b) {
                var _, C = r.$errorContainer,
                    y = r.fileManager;
                if (t.isEmpty(n.attr("multiple")) && (p = 1), b >= p) return r.unlock(), r.duplicateErrors.length && (_ = "<li>" + r.duplicateErrors.join("</li><li>") + "</li>", 0 === C.find("ul").length ? C.html(r.errorCloseButton + "<ul>" + _ + "</ul>") : C.find("ul").append(_), C.fadeIn(r.fadeDelay), r._handler(C.find(".kv-error-close"), "click", function () {
                    C.fadeOut(r.fadeDelay)
                }), r.duplicateErrors = []), r.isAjaxUpload ? (r._raise("filebatchselected", [y.stack]), 0 !== y.count() || r.isError || r.reset()) : r._raise("filebatchselected", [i]), l.removeClass("file-thumb-loading"), void s.html("");
                r.lock(!0);
                var x, T, F, I, P, E, k, S, A, D, z, M, U, j, $ = i[b],
                    R = u + "-" + r._getFileId($),
                    O = f.text,
                    B = f.image,
                    L = f.html,
                    ...
                    K = function () {
                        ...
                        }, r.processDelay), r._raise("fileloaded", [$, R, b, o]) && r.isAjaxUpload && y.add($)
                    };
                if ($) {
                    if (S = y.getId($), m > 0)
                        for (T = 0; m > T; T++) E = g[T], k = r.msgFileTypes[E] || E, V += 0 === T ? k : ", " + k;
                    if (Z === !1) return void a(b + 1);
                    if (0 === Z.length) return F = r.msgInvalidFileName.replace("{name}", t.htmlEncode(t.getFileName($), "[unknown]")), void w(F, $, R, b, S);
                    if (t.isEmpty(v) || (H = new RegExp("\\.(" + v.join("|") + ")$", "i")), x = N.toFixed(2), r.isAjaxUpload && y.exists(S) || r._getFrame(R, !0).length) {
                        var Q = {
                            id: R,
                            index: b,
                            fileId: S,
                        ...
                        return F = r.msgDuplicateFile.setTokens({
                            name: Z,
                            size: x
                        }), void (r.isAjaxUpload ? setTimeout(function () {
                            r.duplicateErrors.push(F), r._raise("fileduplicateerror", [$, S, Z, x, R, b]), a(b + 1), r._updateFileDetails(p)
                        }, r.processDelay) : (r._showError(F, Q), r.unlock(), p = 0, r._clearFileInput(), r.reset(), r._updateFileDetails(p)))
                    }
                    if (r.maxFileSize > 0 && N > r.maxFileSize) return F = r.msgSizeTooLarge.setTokens({
                        name: Z,
                        size: x,
                        maxSize: r.maxFileSize
                    }), void w(F, $, R, b, S);
                    if (null !== r.minFileSize && N <= t.getNum(r.minFileSize)) return F = r.msgSizeTooSmall.setTokens({
                        name: Z,
                        size: x,
                        minSize: r.minFileSize
                    }), void w(F, $, R, b, S);
                    if (!t.isEmpty(g) && t.isArray(g)) {
                        for (T = 0; T < g.length; T += 1) I = g[T], D = f[I], q += D && "function" == typeof D && D($.type, t.getFileName($)) ? 1 : 0;
                        if (0 === q) return F = r.msgInvalidFileType.setTokens({
                            name: Z,
                            types: V
                        }), void w(F, $, R, b, S)
                    }
                    if (0 === q && !t.isEmpty(v) && t.isArray(v) && !t.isEmpty(H) && (P = t.compare(Z, H), q += t.isEmpty(P) ? 0 : P.length, 0 === q)) return F = r.msgInvalidFileExtension.setTokens({
                        name: Z,
                        extensions: h
                    }), void w(F, $, R, b, S);
                    if (!r._canPreview($)) return A = r.isAjaxUpload && r._raise("filebeforeload", [$, b, o]), r.isAjaxUpload && A && y.add($), r.showPreview && A && (l.addClass("file-thumb-loading"), r._previewDefault($), r._initFileActions()), void setTimeout(function () {
                        A && r._updateFileDetails(p), a(b + 1), r._raise("fileloaded", [$, R, b])
                    }, 10);
                    z = O($.type, Z), M = L($.type, Z), U = B($.type, Z), s.html(d.replace("{index}", b + 1).replace("{files}", p)), l.addClass("file-thumb-loading"), o.onerror = function (e) {
                        r._errorHandler(e, Z)
                    }, o.onload = function (i) {
                        var a, n, l, s, d, c, u = [],
                            p = function (e) {
                                ...
                                t.onerror = function (e) {
                                    ...
                                    r.isAjaxUpload && !r._raise("filebeforeload", [$, b, o]) || (r._previewFile(b, $, e, W, n), r._initFileActions(), K())
                        ...
                        if (n = {
                            ...
                            "object" !== e && "other" !== e && "function" == typeof t && t($.type, Z) && G++
                        }), 0 === G) {
                            for (l = new Uint8Array(i.target.result), T = 0; T < l.length; T++) s = l[T].toString(16), u.push(s);
                            if (a = u.join("").toLowerCase().substring(0, 8), c = t.getMimeType(a, "", ""), t.isEmpty(c) && (d = t.arrayBuffer2String(o.result), c = t.isSvg(d) ? "image/svg+xml" : t.getMimeType(a, d, $.type)), n = {
                                name: Z,
                                type: c
                            }, z = O(c, ""), M = L(c, ""), U = B(c, ""), j = z || M, j || U) return void p(j)
                        }
                        r.isAjaxUpload && !r._raise("filebeforeload", [$, b, o]) || (r._previewFile(b, $, i, W, n), r._initFileActions(), K())
                    ...
                    }, z || M ? o.readAsText($, r.textEncoding) : U ? o.readAsDataURL($) : o.readAsArrayBuffer($)
                }
            }, a(0), r._updateFileDetails(p, !0)
        },
        lock: function (e) {
            var t = this,
                i = t.$container;
        ...
        msgDuplicateFile: 'El archivo "{name}" con tamaño "{size} KB" ya está seleccionado anteriormente.',
